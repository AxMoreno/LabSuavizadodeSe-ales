# -*- coding: utf-8 -*-
"""
Created on Mon Nov 18 23:55:51 2019
...
plt.plot(mean_smooth,color='b', label ='data smoothing')
plt.plot(sig_input_sensor,color='c',label='original samples')
plt.show()
